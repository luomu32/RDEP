...
public class DbTest {
    ...
    public void testTaskDateRangeQueryWithSpecification() {
        ...
        Page<Task> noTasks = taskRepo.findAll(new DateRangeSpec(
        ...
        Page<Task> oneTask = taskRepo.findAll(new DateRangeSpec(
                LocalDate.of(2020, 04, 8),
                LocalDate.of(2020, 04, 11)
        ), pageable);
        assertThat(oneTask).hasSize(1);

        Page<Task> afterTask = taskRepo.findAll(new DateRangeSpec(
    ...
    static class DateRangeSpec implements Specification {
